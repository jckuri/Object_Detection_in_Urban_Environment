...
|Clone the github repository of the dataset outside of the project directory: `git clone https://github.com/jckuri/Object_Detection_in_Urban_Environment_DATASET.git`|
