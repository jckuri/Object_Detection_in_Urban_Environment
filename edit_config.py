"""
This module edits the config file.
"""
...
from object_detection.protos import pipeline_pb2 # pylint: disable=import-error
...
def edit(train_dir, eval_dir, batch_size, checkpoint, label_map):
    ...
    with tf.gfile.GFile("pipeline.config", "r") as file:
        proto_str = file.read()
    ...
    with tf.gfile.Open("pipeline_new.config", "wb") as file:
